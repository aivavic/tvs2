...
class Subscribes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_tvseries, id_user', 'required'),
			array('id_tvseries, id_user, phone, email', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_tvseries, id_user, phone, email', 'safe', 'on'=>'search'),
		);
	}
