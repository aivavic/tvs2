        ...
        if (isset($_POST['LoginForm'])) {
            ...
            if ($model->validate() && $model->login()) {
                ...
                if (Yii::app()->user->checkAccess('1')) {
                    $this->redirect(Yii::app()->createUrl('user/personal'));
                }
        ...
        if (isset($_POST['User'])) {
            ...
            if ($model->save()){
                if($setting->defaultStatusUser == 1){
                    Yii::app()->user->setFlash('registration', 'Регистрация прошла успешно. Вы можете авторизирроваться');
                } else {
                    Yii::app()->user->setFlash('registration', 'Ожидайте подтверждения администратора');
                }
