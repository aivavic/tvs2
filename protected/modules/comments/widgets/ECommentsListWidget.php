...
{       
	...
	public function run()
	{
            ...
            $options = CJavaScript::encode(array(
                'dialogTitle' => Yii::t('CommentsModule.msg', 'Добавить комментарий'),
                'deleteConfirmString' => Yii::t('CommentsModule.msg', 'Удалить этот комментарий?'),
                'approveConfirmString' => Yii::t('CommentsModule.msg', 'Подтверить комментарий?'),
                'postButton' => Yii::t('CommentsModule.msg', 'Комментировать'),
                'cancelButton' => Yii::t('CommentsModule.msg', 'Отменить'),
            ));
