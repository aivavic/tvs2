...
<?php
    ...
    if($this->registeredOnly === false || Yii::app()->user->isGuest === false)
    {
        echo CHtml::link(Yii::t('CommentsModule.msg', 'Комментировать'), '#', array('rel'=>0, 'class'=>'add-comment'));
    }
    else 
    {
        echo '<strong>'.Yii::t('CommentsModule.msg', 'Вы не можете оставить комментарий, зарегистрируйтесь').'</strong>';
    }
?>
</div>
