...
;(function($, window, document, undefined) {
	...
	Owl.prototype.onDragStart = function(event) {
		...
		$(document).on('mousemove.owl.dragEvents mouseup.owl.dragEvents touchmove.owl.dragEvents touchend.owl.dragEvents', jQuery.proxy(function(event) {this.eventsRouter(event)},this));
	};
...
;(function($, window, document, undefined) {
	...
	var Hash = function(carousel) {
		...
		$(window).on('hashchange.owl.navigation', jQuery.proxy(function() {
